...
Different from the [AMALTHEA PREM IP](../prem/readme.md), where the designer needs to change constants to set the behavior of the IP in design time, in the *Configurable AMALTHEA PREM IP* this configuration is set in runtime, in the FRED software. Check the software example located in *sw/src*.
